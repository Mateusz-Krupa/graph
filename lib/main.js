...
fetch('https://raw.githubusercontent.com/jscriptcoder/datasets/master/shareprice.json').then(function (response) {
    ...
    let chart = items.map((item, index) => [item[0] * 1000, item[1]]);
    paint(chart);
